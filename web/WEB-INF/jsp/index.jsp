...
<img src="/image/bilil1.png" class="bilil"  id="bilil">
    <form action="/my" id="form">
        <label>Username</label><br><input type="text" id="user"><span id="userV"></span><br>
        <label>Password</label><br><input type="password" id="pass" onfocus="changebili1(1)" onblur="changebili1(2)"><span id="passV"></span><br>
